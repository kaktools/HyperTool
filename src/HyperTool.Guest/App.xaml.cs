...
{
    private const string CurrentGuestWhatsNewNoticeVersion = "2026-07-v271-launch-hotfix";
    ...
    private async Task TryShowGuestVersionInfoOnFirstStartAsync()
    {
        ...
        try
        {
            ...
            var infoLines = string.Join("\n", new[]
            {
                ...
                "- USB-Status im Guest ist deutlicher sichtbar (Connected/Attached/Busy als klarere visuelle Status-Badges)."
            });
    ...
    private async Task TryDisconnectAllAttachedUsbOnSessionEndingAsync()
    {
        ...
        await WaitForShutdownDisconnectDrainAsync(
            ...
            disconnectedCount: result.DisconnectedCount,
            timedOut: result.TimedOut,
            maxWait: TimeSpan.FromSeconds(4),
