    ...
    private async Task ShowStartupUpdatePromptAsync()
    {
        ...
        try
        {
            ...
            var dialog = new ContentDialog
            {
                ...
                Content = "Für HyperTool ist ein Update verfügbar. Empfohlen, da aktuelle Releases u. a. Shutdown-/USB-Stabilitätsverbesserungen enthalten. Soll das Update jetzt installiert werden?",
